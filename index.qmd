...
author: "<b>Sushovan Majhi</b>, *George Washington University, DC*<br/> <green>Joint work</green> with Kazuhiro Kawamura, Atish Mitra"
...
- Metric Graphs [*J. Appl. & Comp. Top., @Majhi2023*]
- Riemannian Manifolds [*SoCG'24, DCG, @MajhiLatschev*]
...
- $(X, d_X)$ metric space 
- Indexed set: $\mathcal{S}\coloneqq\{S\subset X\ : \lvert S\rvert<\infty\}$ under set inclusion
- For any scale $\beta\geq0$, a direct system of groups: 
- $$\left\{\pi_m(\mathcal{R}_\beta(S))\to \pi_m(\mathcal{R}_\beta(T))\mid S,T\in\mathcal{S}, S\subset T\right\}$$
...
$$
\lim_{S\in\mathcal{S}} \pi_m(\mathcal{R}_\beta(S)) \cong \pi_m(\mathcal{R}_\beta(X)).
$$
:::
...
$$
\lim_{S\in\mathcal{S}} \pi_m(\mathcal{R}_\beta(S)) \cong \pi_m(X).
$$
:::
